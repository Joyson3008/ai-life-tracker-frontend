  ...
  return (
    <main className={`apple-login ${darkMode ? "apple-dark" : "apple-light"}`}>
      <style>{`
        ...
        .login-content { margin-top:auto; }.login-content h2 { margin:0 0 14px;padding-left:2px;font-size:22px;line-height:1.25;letter-spacing:-.025em;font-weight:700; }.login-field { margin-top:14px; }.login-field label { display:block;margin:0 0 7px;padding-left:2px;color:var(--secondary);font-size:13px;font-weight:600;letter-spacing:.01em; }.field { position:relative;min-height:58px;display:flex;align-items:center;border-radius:15px;background:var(--surface);border:1px solid var(--separator);box-shadow:0 1px 2px rgba(0,0,0,.03);transition:background .16s ease,border-color .16s ease,box-shadow .16s ease; }.field-icon { width:52px;flex:0 0 52px;display:grid;place-items:center;color:var(--secondary);transition:color .16s ease; }.field-icon svg { width:19px;height:19px; }
        .apple-input { width:100%;min-height:56px;padding:0 14px 0 0;border:0;outline:0;color:var(--text);background:transparent;font:inherit;font-size:17px;letter-spacing:-.01em;caret-color:var(--blue); }.apple-input::placeholder { color:color-mix(in srgb,var(--secondary) 82%,transparent); }.apple-input::selection { background:color-mix(in srgb,var(--blue) 28%,transparent); }.apple-input:focus,.apple-input:focus-visible { outline:0;box-shadow:none; }.apple-input:-webkit-autofill { -webkit-text-fill-color:var(--text); box-shadow:0 0 0 100px var(--surface) inset; transition:background-color 9999s ease-in-out 0s; }.password-input { padding-right:48px; }.password-toggle { position:absolute;right:4px;top:6px;width:44px;height:44px;color:var(--secondary); }.password-toggle:hover { color:var(--text); }.field:focus-within { background:color-mix(in srgb,var(--blue) 5%,var(--surface));border-color:var(--blue);box-shadow:0 0 0 3px color-mix(in srgb,var(--blue) 22%,transparent); }.field:focus-within .field-icon { color:var(--blue); }
